...
<body class="sidebar-light">
 ...
 <div class="col-md-4 col-sm-11 col-xs-12"></div>
 <div class="col-md-4 col-sm-11 col-xs-12" style="top-margin:2px">
 
 <button type="button" class="btn btn-primary"  style="color:#fff; justify-content:left">
...
<?php
   ...
   <button type="button" class="btn btn-primary">
     <a href="./login1.php" ><h1 class="display-4" style="color:#fff">Order Online</h1></a>
     </button>
